...
public class BetBoomSportsMap {
    ...
    private static final Map<String, Integer> SPORT_ZIP = ZIP_SPORT.entrySet()
            .stream()
    ...
    public static Optional<String> getSport(Integer sportZIP) {
        return Optional.ofNullable(ZIP_SPORT.get(sportZIP));
    }
}
